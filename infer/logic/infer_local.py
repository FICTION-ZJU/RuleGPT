...
device = "cuda:4"  # the device to load the model onto
# os.environ["CUDA_VISIBLE_DEVICES"] = "4,5,6,7"
model_name_or_path = "/data1/syt/all_models/Qwen2.5-7B-Instruct_1111"
...
def process_rules(rules):
    ...
    for rule in rules:
        ...
        num = 0
        output_str = ""
        prompt = rule  + "Please give me the logic relations only with nothing else. Use '&' for 'and', '|' for 'or'. Use A,B,C... for basic events."
...
output_directory = './result/2.5_7b_ori/logic_new' 
